...
const heroSlides = [
  {
    eyebrow: "Enviroserve for the Planet",
    title: "Build, Recycle, Repeat for a Greener Tomorrow",
    description: "Join hands with us to build a sustainable and eco-friendly tomorrow with certified CPCB construction & material recycling.",
    buttonText: "Join the Mission",
    buttonHref: "/services/e-waste-recycling",
    image: "/images/hero/hero-home-dslr.jpg",
  },
  {
    eyebrow: "Building a Circular Future",
    title: "Responsible Recycling. Smarter EPR Compliance.",
    description: "Connecting recyclers, producers, dismantlers, and aggregators through traceable waste management solutions.",
    buttonText: "Explore Our Services",
    buttonHref: "/services/e-waste-epr",
    image: "/images/hero/hero-services-dslr.jpg",
  },
  {
    eyebrow: "E-Waste Management Experts",
    title: "Recycle Responsibly. Recover Resources.",
    description: "Safe disposal and certified recycling of electronic waste — protecting people, planet, and compliance.",
